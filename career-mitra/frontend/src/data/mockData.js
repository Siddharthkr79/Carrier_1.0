...
export const mockMentors = [
  {
    ...
    skills: ['React', 'Node.js', 'System Design', 'Web Development'],
    experience: 12,
    rating: 4.9,
    reviews: 347,
    sessionFee: 2000,
  ...
  },
  {
    ...
    skills: ['Machine Learning', 'Python', 'Data Analysis', 'AI/ML'],
    experience: 8,
    rating: 4.7,
    reviews: 215,
    sessionFee: 1500,
  ...
  },
  {
    ...
    company: 'Netflix',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop',
    skills: ['Kubernetes', 'Docker', 'CI/CD', 'Cloud Infrastructure'],
    experience: 9,
    rating: 4.9,
    reviews: 256,
    sessionFee: 1800,
